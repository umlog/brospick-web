...
주요 강점:
- 킥: 중·장거리 킥 정확도 (능력치 88점)
- 패스: 빌드업 중심의 안정적 전개 (능력치 90점)
- 슈팅: 2선 침투 후 마무리 능력 (능력치 85점)
- 수비: 중원 압박, 볼 회수 능력 (능력치 83점)
...
> - 우리는 선수출신 2명과 개발자 1명이 함께 창업했습니다.  
> - 대학교를 휴학하고 ‘이’ 스포츠 메거진 앱을 만들었습니다.  
> - 해외의 433처럼, 국내에서는 색다른 **스포츠 커뮤니티**를 만들고 있습니다.  
> - 인스타 릴스, 앱 개발, 운동복 제작 등 다양한 시도를 이어가고 있습니다.  
> - “체육 전공생도 스포츠를 키워드로 회사를 만들 수 있다”는 걸 보여드리겠습니다.  
>  
> 우리는 **브로스픽(Brospick)** 입니다.`,
    highlights: [
      '수원삼성 유스 출신',
      'TNT FC 활동 후 호주 진출',
