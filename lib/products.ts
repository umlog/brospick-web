...
export const products: Record<ProductSlug, Product> = {
  ...
  [PRODUCT_SLUGS.BOOTSKIN_NUMBER]: {
    ...
    detailBanners: [
      '/apparel/bootskin/BootSkinBanner/1.png',
      '/apparel/bootskin/BootSkinBanner/2.png',
      '/apparel/bootskin/BootSkinBanner/3.png',
      '/apparel/bootskin/BootSkinBanner/4.png',
      '/apparel/bootskin/BootSkinBanner/5.png',
      '/apparel/bootskin/BootSkinBanner/6.png',
      '/apparel/bootskin/BootSkinBanner/7.png',
      '/apparel/bootskin/BootSkinBanner/8.png',
      '/apparel/bootskin/BootSkinBanner/9.png',
      '/apparel/bootskin/BootSkinBanner/10.png',
      '/apparel/bootskin/BootSkinBanner/11.png',
      '/apparel/bootskin/BootSkinBanner/12.png',
      '/apparel/bootskin/BootSkinBanner/13.png',
    ...
    images: [
      ...
      '/apparel/bootskin/number/1-0-white.png',
      '/apparel/bootskin/number/2-1-white.png',
      '/apparel/bootskin/number/3-2-white.png',
      '/apparel/bootskin/number/4-3-white.png',
      '/apparel/bootskin/number/5-4-white.png',
      '/apparel/bootskin/number/6-5-white.png',
      '/apparel/bootskin/number/7-6-white.png',
    ...
    details: {
      ...
      design: [
        { title: '블랙 & 화이트 컬러', description: '어떤 부츠 색상에도 잘 어울리는 베이직 블랙과 화이트.' },
      ],
      material: '방수 접착 소재.',
    },
  },
  ...
  [PRODUCT_SLUGS.BOOTSKIN_ALPHABET]: {
    ...
    images: [
      ...
      '/apparel/bootskin/initial/1-A-white.png',
      '/apparel/bootskin/initial/2-B-white.png',
      '/apparel/bootskin/initial/3-C-white.png',
      '/apparel/bootskin/initial/4-D-white.png',
      '/apparel/bootskin/initial/5-E-white.png',
      '/apparel/bootskin/initial/6-F-white.png',
      '/apparel/bootskin/initial/7-G-white.png',
      '/apparel/bootskin/initial/8-H-white.png',
      '/apparel/bootskin/initial/9-I-white.png',
      '/apparel/bootskin/initial/10-J-white.png',
      '/apparel/bootskin/initial/11-K-white.png',
      '/apparel/bootskin/initial/12-L-white.png',
      '/apparel/bootskin/initial/13-M-white.png',
      '/apparel/bootskin/initial/14-N-white.png',
      '/apparel/bootskin/initial/15-O-white.png',
      '/apparel/bootskin/initial/16-P-white.png',
      '/apparel/bootskin/initial/17-Q-white.png',
      '/apparel/bootskin/initial/18-R-white.png',
      '/apparel/bootskin/initial/19-S-white.png',
      '/apparel/bootskin/initial/20-T-white.png',
      '/apparel/bootskin/initial/21-U-white.png',
      '/apparel/bootskin/initial/22-V-white.png',
      '/apparel/bootskin/initial/24-W-white.png',
  ...
  [PRODUCT_SLUGS.BOOTSKIN_SYMBOL]: {
    ...
    images: [
      ...
      '/apparel/bootskin/faith-symbol/3-PHIL-413-detail.png',
      '/apparel/bootskin/faith-symbol/3-PHIL-4-13.png',
      '/apparel/bootskin/faith-symbol/3-PHIL-413-additional-detail.png',
      ...
      '/apparel/bootskin/faith-symbol/6-BELEVE-detail.png',
  ...
  [PRODUCT_SLUGS.BOOTSKIN_CUSTOM]: {
    ...
    tagline: '나만의 디자인을 부츠에 — 완전 주문제작 부츠스킨.',
    description: '원하는 디자인으로 제작하는 커스텀 부츠스킨입니다. 인쇄 판 제작이 필요하여 최소 10세트부터 주문 가능합니다. 결제 완료 후 인스타그램 DM(@team.brospick)으로 원하시는 디자인을 공유해주세요. 같은 디자인으로 재주문 시에는 추후 1세트씩 낱개 구매도 가능합니다.',
    sizes: ['커스텀'],
    sizeLabel: '주문 유형',
    sizeChart: [],
    features: [
      { label: '완전 커스텀', detail: ' — 원하는 디자인으로 직접 제작' },
      { label: '최소 10세트', detail: ' — 인쇄 판 제작 필요' },
      { label: '무료배송', detail: ' — 최소 주문 금액 자동 달성' },
    ],
    details: {
      functions: [
        { title: '주문 방법', description: '결제 완료 후 인스타그램 DM(@team.brospick)으로 원하시는 디자인(이미지·설명)을 공유해주세요.' },
        { title: '강한 접착력', description: '경기 중 충격과 마찰에도 쉽게 떨어지지 않는 내구성.' },
      ],
      design: [
        { title: '기본 사이즈', description: '가로 0.8cm × 세로 1cm. 별도 요청 주시면 변경 가능합니다.' },
        { title: '재주문', description: '같은 디자인으로 재주문 시 추후 1세트씩 낱개 구매 가능.' },
      ],
      material: '방수 접착 소재.',
    },
  },
