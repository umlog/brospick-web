...
export const products: Record<ProductSlug, Product> = {
  ...
  [PRODUCT_SLUGS.BOOTSKIN_SYMBOL]: {
    ...
    tagline: '믿음을 부츠에 — 십자가, JESUS, 빌립보서 4:13, 100% JESUS, GOD, BELEVE, GLORY TO GOD 심볼 스티커.',
    description: '축구화나 럭비화에 붙이는 신앙 심볼 부츠스킨입니다. CROSS, JESUS, PHIL 4:13, 100% JESUS, GOD, BELEVE, GLORY TO GOD 중 원하는 심볼을 선택해 주문하세요.',
    sizes: ['CROSS', 'JESUS', 'PHIL 4:13', '100% JESUS', 'GOD', 'BELEVE', 'GLORY TO GOD'],
    features: [
