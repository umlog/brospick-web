...
export const products: Record<ProductSlug, Product> = {
  ...
  [PRODUCT_SLUGS.BOOTSKIN_NUMBER]: {
    ...
    sizes: ['0-black', '0-white', '1-black', '1-white', '2-black', '2-white', '3-black', '3-white', '4-black', '4-white', '5-black', '5-white', '6-black', '6-white', '7-black', '7-white', '8-black', '8-white', '9-black', '9-white'],
    features: [
